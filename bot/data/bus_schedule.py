...
class BusSchedule:
    next_departure: str
    next_return: str
    remaining_dep_buses: tuple[str] = dc.field()
    remaining_ret_buses: tuple[str] = dc.field()
    ...
    def __repr__ (self) -> str:
        ...
        return f"|{self.next_departure:^13}|{self.next_return:^13}|"

# Horários dos ônibus

# Dia útil
business_day_departure_list = deque((
    '(A) 06:30 (P)', '06:45', '06:50', '07:00', '07:10', '07:15', '07:20', '(A) 07:25 (P)', '07:35', '(A) 07:40 (P)', '07:45', '(A) 08:00 (P)',
    '    08:10 (P)', '08:20', '08:30', '08:40', '08:50', '09:00', '09:10', '09:20', '09:30', '09:40', '    09:45 (P)', '10:05',
    '10:15', '10:30', '10:45', '11:00', '    11:20 (P)', '11:30', '11:45', '12:00', '12:15', '12:20', '12:35', '12:45',
    '13:00', '13:05', '    13:20 (P)', '13:30', '13:45', '14:00', '14:15', '14:30', '14:45', '15:00', '    15:15 (P)', '15:30',
    '15:45', '16:00', '    16:15 (P)', '16:30', '16:45', '(A) 17:00 (P)', '17:30', '17:45', '    18:00 (P)', '18:10', '18:20', '18:25',
    '18:30', '18:40', '18:55', '19:00', '19:15', '19:25', '19:35', '19:50', '19:55', '20:10', '20:30', '20:45'
))

business_day_return_list = deque((
    '07:20', '07:40', '    08:00 (P)', '08:25', '08:45', '    09:00 (P)', '09:30', '09:50', '10:00', '10:15', '10:40', '11:05',
    '11:15', '11:30', '11:45', '11:55', '12:00', '12:20', '    12:30 (P)', '12:45', '12:50', '13:00', '13:15', '    13:30 (P)',
    '13:45', '14:00', '14:15', '    14:30 (P)', '14:45', '15:00', '15:15', '15:30', '15:45', '16:00', '16:15', '    16:30 (P)',
    '16:45', '17:15', '17:30', '(A) 17:40 (P)', '17:45', '(A) 17:50 (P)', '(B) 18:00    ', '18:15', '(C) 18:20    ', '(B) 18:30    ', '18:40', '(C) 18:50    ',
    '19:05', '(B) 19:10    ', '(C) 19:25    ', '19:35', '(B) 19:45    ', '(C) 20:05    ', '(B) 20:20    ', '20:40', '(B) 20:50    ', '(C) 21:00    ', '(B) 21:25    ', '(C) 21:35    ',
    '21:55', '(B) 22:00    ', '22:10', '22:20', '(B) 22:30    ', '22:35', '22:45', '23:05', '23:15', '23:25', '(C) 23:35    ', '(B) 23:45    '
))
...
def create_bus_schedule(
    ...
    for _ in range(MINUTES_IN_A_DAY):
        ...
        bus_schedule[time_as_str] = BusSchedule(
            ...
            tuple(return_), is_weekend, is_first_bus,
            is_last_bus
        )
        is_first_bus = False
