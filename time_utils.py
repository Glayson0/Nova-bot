...
def str_to_time(time: str) -> datetime:
    """Essa função converte horários do tipo str no formato '%H:%M' para
    datetime no formato 'ano-mês-dia hora:minuto'
    """
...
def calc_time_diff(
    ...
    """Essa função calcula a diferença de tempo entre dois horários do tipo
    datetime
    """
    ...
    time_diff = endTime - timedelta(hours=startTime.hour,
